...
const uint8_t font8x8h[][8] PROGMEM = {
  ...
  {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff},       // Ascii 128     ausgefuelltes Quadrat
  {0x70,0xd8,0xd8,0x70,0x00,0x00,0x00,0x00},       // Ascii 129     Grad Celcius Zeichen
  {0x38,0x44,0x82,0x44,0x28,0xaa,0xee,0x00}        // Ascii 130     Ohm - Zeichen
};
